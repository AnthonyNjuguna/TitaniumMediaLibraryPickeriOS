...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.behindmedia.medialibrarypicker.js')
	...
	f = os.path.join(cwd,'Classes','ComBehindmediaMedialibrarypickerModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.behindmedia.medialibrarypicker.js']
